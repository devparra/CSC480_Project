...
//    public static Database db;
    ...
    public boolean updateUser(User user){
        ...
        Call<User> call = retrofitAPI.updateUser(user.getUserID(), user);
    ...
    public boolean deleteUser(User user){
        ...
        Call<Void> call = retrofitAPI.deleteUser(user.getUserID());
    ...
    public ArrayList<WorkOrder> getWorkOrder(User user){
        ...
        Call<ArrayList<WorkOrder>> call = retrofitAPI.getWorkOrders(user.getUserID());
